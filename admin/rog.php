            ...
            <div class="row">
                <div class="card">
                    <div class="card-header">
                        <h5 class="card-title mb-0">Uploaded ROG Files</h5>
                    </div>
                    <div class="card-body">
                        <?php
                            ...
                            <table class="table table-striped">
                                ...
                                <tbody>
                                    <?php while ($row = $result->fetch_assoc()) { ?>
                                        <tr>
                                            <td><?php echo htmlspecialchars(pathinfo($row['rog_path'], PATHINFO_FILENAME)); ?></td> <!-- Display the file name -->
                                            <td>
                                                <?php if ($row['rog_path']) { ?>
                                                    <a  class="btn btn-primary"href="<?php echo htmlspecialchars($row['rog_path']); ?>" download>Download ROG</a>
                                                <?php } else { ?>
                                                    No File
                                                <?php } ?>
                                            </td>
