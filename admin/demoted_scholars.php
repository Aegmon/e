...
$eligibleCount = getCount('Demoted');  
$ineligibleCount = getCount('Demoted'); 
              ...
              <div class="row">
                <!-- Display Cards for each count -->
                 <div class="col-md-4 col-sm-12" style="height:100%;">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title">Total No. of Demoted Applicants</h5>
               ...
               <div class="col-md-4 col-sm-12">
                     <div class="card">
                        <div class="card-header">Demoted Applicants per Baranggay</div>
                        <div class="card-body">
                   ...
                   <div class="col-md-4 col-sm-12">
                     <div class="card">
                        <div class="card-header">Demoted Applicants per Course</div>
                        <div class="card-body">
        ...
        <div class="card-body">
            ...
            <div class="table-responsive">
                               ...
                               <table class="table p-2" id="filterTableGrantedLevel1">
                                    ...
                                    <tbody>
                                        <?php
                                             $qry = "SELECT * from applicants WHERE status = 'Demoted'"; 
...
$(document).ready(function() {
    // Bar chart for Demoted Applicants per Barangay
