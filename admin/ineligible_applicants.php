   ...
   Ineligible Applicants
              ...
              <div class="row">
                <!-- Display Cards for each count -->
                 <div class="col-md-4 col-sm-12" style="height:100%;">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title">Total No. of Ineligible Applicants</h5>
               ...
               <div class="col-md-4 col-sm-12">
                     <div class="card">
                        <div class="card-header">Ineligible Applicants per Baranggay</div>
                        <div class="card-body">
                   ...
                   <div class="col-md-4 col-sm-12">
                     <div class="card">
                        <div class="card-header">Ineligible Applicants per Course</div>
                        <div class="card-body">
    ...
    <div class="card">
        <div class="card-header">
            <h4> List Ineligible Applicants</h4>
        </div>
        <div class="card-body">
...
$(document).ready(function() {
    // Bar chart for Ineligible Applicants per Barangay
    new Chart(document.getElementById("barChart"), {
        type: "bar",
        data: {
            labels: <?php echo $barangayLabels; ?>,
            datasets: [{
                label: "Ineligible Applicants per Barangay",
    ...
    // Bar chart for Ineligible Applicants per Course
    new Chart(document.getElementById("barChart2"), {
        type: "bar",
        data: {
            labels: <?php echo $courseLabels; ?>,
            datasets: [{
                label: "Ineligible Applicants per Course",
