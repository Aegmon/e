...
$eligibleCount = getCount('Graduted');  
$ineligibleCount = getCount('Graduted'); 
   ...
   Graduted Applicants
              ...
              <div class="row">
                <!-- Display Cards for each count -->
                 <div class="col-md-4 col-sm-12" style="height:100%;">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title">Total No. of Graduted Applicants</h5>
               ...
               <div class="col-md-4 col-sm-12">
                     <div class="card">
                        <div class="card-header">Graduted Applicants per Baranggay</div>
                        <div class="card-body">
                   ...
                   <div class="col-md-4 col-sm-12">
                     <div class="card">
                        <div class="card-header">Graduted Applicants per Course</div>
                        <div class="card-body">
    ...
    <div class="card">
        <div class="card-header">
            <h4> List Graduted Applicants</h4>
        </div>
        <div class="card-body">
            ...
            <div class="table-responsive">
                                  ...
                                  <table class="table p-2" id="filterTableGrantedLevel1">
                                    ...
                                    <tbody>
                                        <?php
                                             $qry = "SELECT * from applicants WHERE status = 'Graduated'"; 
...
$(document).ready(function() {
    // Bar chart for Graduted Applicants per Barangay
    new Chart(document.getElementById("barChart"), {
        type: "bar",
        data: {
            labels: <?php echo $barangayLabels; ?>,
            datasets: [{
                label: "Graduted Applicants per Barangay",
    ...
    // Bar chart for Graduted Applicants per Course
    new Chart(document.getElementById("barChart2"), {
        type: "bar",
        data: {
            labels: <?php echo $courseLabels; ?>,
            datasets: [{
                label: "Graduted Applicants per Course",
