...
?>
  ...
  background-size:  112%;">
						...
						<div class="col-md-4 col-xl-3">
							<div class="card mb-3">
								...
								<div class="card-body text-center">
									...
									<div class="text-muted mb-2">Scholarship Status <?php echo $schstat?></strong></div>
								...
								<div class="card-body">
									...
									<ul class="list-unstyled mb-0">
										...
										<li class="mb-1"><span data-feather="user" class="feather-sm me-1"></span>Scholarship Type <a href="#"><?php echo $scholarType?></a></li>
    ...
    <div class="card-body">
        <?php 
           $qry = "SELECT * FROM announcements ORDER BY id DESC, date DESC";
            $ses_sql = mysqli_query($con, $qry);
            while ($row = mysqli_fetch_array($ses_sql)) {
        ?>
            <div class="card mb-3">
                <div class="card-header">
                    <h6 class="text-center mb-0"><?php echo $row['subject']; ?></h6><span><small><?php echo $row['date']; ?></small></span>
                </div>
                <div class="card-body">
                    <p><?php echo $row['content']; ?></p>
					
					 <img src="../uploads/<?php echo $row['image']; ?>" alt="" class="img-fluid mb-2 text-center"  height="300" />
                </div>
            </div>
        <?php 
            }
