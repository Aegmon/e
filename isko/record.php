                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                             ...
                                             <td style="text-align: center;">
                                                       ...
                                                       <button class="btn btn-primary" onclick="window.location.href='update.php?id=<?php echo $rowid; ?>'">Update</button>
                                            ...
                                            <tr>
                                               ...
                                               <td style="text-align: center;"><?php echo $row['status'];?></td>
                                                ...
                                                <td style="text-align: center;"><?php echo $email;?></td>
                                                    ...
                                                    <button class="btn btn-primary" data-toggle="modal" data-target="#<?php echo $rowid; ?>">Update</button>
                                                       <button class="btn btn-secondary" data-toggle="modal" data-target="#<?php echo $rowid; ?>">Archive</button>
                                                </td>
                                            </tr>
