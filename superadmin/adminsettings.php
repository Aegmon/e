...
if(isset($_POST['insert'])){
    ...
    if ($password != $cpassword){
        ...
        if ($sql->num_rows >0){
            ...
            $con->query("INSERT INTO userdata (Email,Password,userRole,token) VALUES ('$email','$hashedPassword','Admin','$token')");
...
?>
		...
		<div class="main" style="background:url('../assets/pubmatfour.png');
  background-size:  100%;">
						...
						<div class="col-12 col-lg-12">
							<div class="card">
								...
								<div class="mb-3">
											...
											<input class="form-control form-control-lg" type="text" name="email"  required="" placeholder="Enter email" />
										</div>
										<div class="mb-3">
                                            ...
                                            <div class="mb-3">
                                         <input type="submit"  class="btn btn-lg btn-primary"  name="insert" value="Add"aria-describedby="basic-addon1" style="background-color: #297506; border-color: border-color: coral;">
										</div>
                                        </form>   
						</div> 
					</div>
