	...
	<div class="wrapper">
		...
		<img src="../assets/SMG LOGO.png" class="img-fluid rounded-circle" width="250" height="250" />
          ...
          <span class="align-middle">Welcome Admin</span>
              ...
              <i class="align-middle" data-feather="users" style="color:#ffff;"></i> <span class="align-middle">Admin Accounts</span>
            </a>
					</li>
              ...
              <i class="align-middle" data-feather="user-plus" style="color:#ffff;"></i> <span class="align-middle">Add Account</span>
            </a>
					</li> 
